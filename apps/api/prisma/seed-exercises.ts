...
const exercises = [
  // CARDIO
  {
    name: 'Running',
    description:
      'A steady-state cardiovascular exercise that involves continuous running at a moderate pace.',
    ...
    mets: 9.8,
    instructions:
      'Start with a light jog to warm up. Maintain a steady pace, keeping your back straight and arms swinging naturally. Cool down with a slower jog or walk.',
  ...
  },
  {
    ...
    mets: 7.5,
    instructions:
      'Adjust the seat to hip height. Pedal at a steady cadence, maintaining resistance that challenges you but allows smooth pedaling.',
  ...
  },
  {
    ...
    mets: 12.0,
    instructions:
      'Hold the rope handles firmly. Swing the rope over your head and jump over it as it reaches your feet. Keep jumps low to conserve energy.',
  ...
  },
  {
    ...
    mets: 10.0,
    instructions:
      'Start standing, drop into a squat position, kick your feet back to a plank, perform a push-up, jump feet back to squat, and explosively jump up.',
  ...
  },
  {
    ...
    mets: 8.5,
    instructions:
      'Push off with your legs, then lean back slightly and pull the handle to your lower ribs. Reverse the motion by extending arms, leaning forward, and bending knees.',
  ...
  // STRENGTH (Upper Body)
  {
    ...
    mets: 8.0,
    instructions:
      'Start in a high plank position. Lower your body until your chest nearly touches the floor, keeping your elbows tucked at a 45-degree angle. Push back up to the starting position.',
  ...
  },
  {
    ...
    mets: 8.0,
    instructions:
      'Grip the bar with palms facing away. Pull your body up until your chin clears the bar, squeezing your shoulder blades together. Lower with control.',
  ...
  },
  {
    ...
    mets: 6.0,
    instructions:
      'Lie flat on the bench. Unrack the bar and lower it to your mid-chest. Press the bar back up until your arms are fully extended.',
  ...
  },
  {
    ...
    mets: 6.0,
    instructions:
      'Stand with feet shoulder-width apart. Hold the bar at collarbone level. Press the bar straight up overhead until your arms are locked out. Lower with control.',
  ...
  },
  {
    ...
    mets: 5.0,
    instructions:
      'Place one knee and hand on a bench. Hold a dumbbell in the other hand. Pull the dumbbell up to your hip, keeping your elbow close to your body. Lower slowly.',
  ...
  // STRENGTH (Lower Body)
  {
    ...
    mets: 6.0,
    instructions:
      'Rest the bar across your upper back. Stand with feet shoulder-width apart. Push your hips back and bend your knees to squat down until your thighs are parallel to the floor. Drive back up.',
  ...
  },
  {
    ...
    mets: 6.0,
    instructions:
      'Stand with the bar over your mid-foot. Hinge at the hips and grip the bar. Keeping your back flat, lift the bar by driving your hips forward and standing tall.',
  ...
  },
  {
    ...
    mets: 7.0,
    instructions:
      'Hold dumbbells by your sides. Step forward with one leg and lower your hips until both knees are bent at a 90-degree angle. Push off the back foot to step into the next lunge.',
  ...
  },
  {
    ...
    mets: 5.0,
    instructions:
      'Sit in the machine and place your feet shoulder-width apart on the sled. Lower the sled until your knees are at 90 degrees, then press it back up without locking your knees.',
  ...
  },
  {
    ...
    mets: 3.0,
    instructions:
      'Stand on the edge of a step. Drop your heels down below the step level, then press up onto your toes as high as possible. Pause at the top and lower slowly.',
  ...
  // STRENGTH (Core)
  {
    ...
    mets: 3.5,
    instructions:
      'Support your weight on your forearms and toes. Keep your body in a straight line from head to heels. Brace your core and hold.',
  ...
  },
  {
    ...
    mets: 4.0,
    instructions:
      'Sit on the floor, lean back slightly, and lift your feet off the ground. Hold a weight with both hands and rotate your torso to touch the weight to the floor on each side.',
  ...
  },
  {
    ...
    mets: 5.0,
    instructions:
      'Hang from a pull-up bar. Keeping your legs straight, raise them until they are parallel to the floor (or higher). Lower them slowly with control.',
  ...
  // FLEXIBILITY
  {
    ...
    mets: 3.3,
    instructions:
      'Flow continuously through a sequence of poses including Mountain Pose, Forward Fold, Plank, Chaturanga, Upward Dog, and Downward Dog, syncing movement with breath.',
  ...
  },
  {
    ...
    mets: 2.0,
    instructions:
      'Sit on the floor with one leg extended and the other bent inward. Reach for the toes of your extended leg, keeping your back straight. Hold for 30 seconds.',
  ...
  // BALANCE
  {
    ...
    mets: 4.0,
    instructions:
      'Stand on one leg holding dumbbells. Hinge at the hips, lowering the weights toward the floor while extending your non-working leg straight back. Return to standing.',
  ...
  // PLYOMETRICS
  {
    ...
    mets: 8.0,
    instructions:
      'Stand in front of a sturdy box. Swing your arms back, bend your knees, and explosively jump onto the box. Land softly in a partial squat. Step down carefully.',
